...
public class PieWatchFaceService extends CanvasWatchFaceService {
    ...
    class PieWatchFaceEngine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            Drawable backgroundDrawable = PieWatchFaceService.this.getResources().getDrawable(R.drawable.bg, null);
...
//                Log.i(TAG, event.toString());
        ...
        @NonNull
        private List<CalendarEvent> getCalendarEvents(long begin) {
